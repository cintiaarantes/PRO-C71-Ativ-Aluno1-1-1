...
//Desafio 01: Importar o firebase para registro das transações
...
export default class TransactionScreen extends Component {
  ...
  //Desafio 02: Função Gerenciar Transação: Quando o botão for pressionado queremos retirar ou devolver o livro do aluno
  handleTransaction = () => {
    
  }

  //Desafio 03: Função abstrata de emprestimo dos livros
  initiateBookIssue = () => {
    console.log("Livro entregue para o aluno!");
  };

  //Desafio 04: Função abstrata de devolução dos livros
  initiateBookReturn = () => {
